  ...
  return (
    <div className='pt-10 pb-[60px] bg-[#f5f5f5] border-b-4 border-b-orange'>
      <div className='min-w-[1200px] w-[1200px] mx-auto flex shadow bg-white rounded-[3px]'>
              ...
              .map((img, index) => (
                <div className='relative' key={index}>
                  <img
                    ...
                    src='https://down-vn.img.susercontent.com/file/894aa508810e69f7380d11410c0a14d1_tn'
                    alt=''
                  />
        ...
        <div className='pt-[20px] pl-[20px] pr-[35px] flex-1'>
          <div className='text-[20px] font-medium'>
            Ốp Điện Thoại Silicon Mềm Chống Sốc 3 Trong 1 Cho IPhone 14 13 12 11 Pro Max X XR 8 7 Plus
          </div>
          <div className='mt-4 flex items-center'>
            <div className='flex items-center gap-[5px] pr-[15px] border-r border-r-gray-300'>
              <span className='text-orange text-base border-b border-b-orange'>4.6</span>
              {Array(5)
                .fill(0)
                .map((star, index) => (
                  <svg
                    ...
                    x={0}
                    y={0}
                    className='fill-orange stroke-orange w-[14px] h-[14px]'
                  >
                    <polygon
            ...
            <div className='flex items-center gap-[5px] px-[15px] border-r border-r-gray-300'>
              <span className='text-base border-b border-b-black uppercase'>6,2K</span>
              <span className='text-sm text-gray-500'>Ratings</span>
            </div>
            <div className='flex items-center gap-[5px] px-[15px]'>
              <span className='text-base uppercase'>30,7K</span>
              <span className='text-sm text-gray-500'>Sold</span>
              <svg
                enableBackground='new 0 0 15 15'
                viewBox='0 0 15 15'
                role='img'
                className='w-[14px] h-[14px] stroke-gray-500 fill-gray-500'
              >
          ...
          <div className='bg-[#fafafa] px-[20px] py-[15px] mt-4'>
            <div className='flex items-center gap-[10px]'>
              <div className='line-through text-gray-400 text-base'>₫39.000</div>
              <div className='text-orange text-[30px] font-medium'>₫24.000</div>
              <div className='bg-orange text-white text-xs ml-[5px] font-semibold py-[0.5px] px-1 rounded-sm uppercase'>
                38% off
              </div>
            </div>
              ...
              <div>
                <div className='flex items-center gap-[10px]'>
                  ...
                  <svg
                    ...
                    viewBox='0 0 15 15'
                    role='img'
                    className='w-[14px] h-[14px] stroke-gray-600 fill-gray-600'
                  >
                    <circle cx='7.5' cy='7.5' fill='none' r='6.5' strokeMiterlimit={10} />
                    <path
                      stroke='none'
                ...
                <div className='mt-1 text-xs text-gray-500'>The best offer for this product on Shopee!</div>
              </div>
            </div>
          </div>
          <div className='mt-16 pl-[20px] flex items-center gap-16 text-gray-500 text-sm'>
            <span>Quantity</span>
            <div className='flex items-center gap-[15px]'>
              ...
              <span>398156 pieces available</span>
            </div>
          </div>
          <div className='pl-[20px] mt-[30px] flex items-center gap-[15px]'>
            <button className='capitalize text-orange flex items-center justify-center gap-[10px] px-[20px] py-[11px] border border-orange bg-[#ffeee8] shadow-sm rounded-sm'>
              <svg
                ...
                x={0}
                y={0}
                className='w-[20px] h-[20px] stroke-orange fill-orange'
              >
                <g>
                  <g>
                    <polyline
          ...
          <div className='mt-8 border-t border-t-gray-200'>
            <div className='flex items-center gap-[20px] px-[20px] py-9'>
              ...
              <span className='text-sm text-gray-500'>Get the items you ordered or get your money back.</span>
            </div>
          </div>
        </div>
      </div>
      <div className='min-w-[1200px] w-[1200px] mx-auto shadow bg-white rounded-[3px] mt-[15px] p-[25px]'>
        ...
        <div className='mt-[30px] m-[15px] text-sm whitespace-pre-wrap leading-loose'>
          ...
          <p className='irIKAp'>
            Truy cập vào tất cả các cổng, điều khiển &amp;amp; Cảm biến. Các nút cảm thấy nhạy cảm
          </p>
          <p className='irIKAp'></p>
          ...
          <p className='irIKAp'>Loại sản phẩm: Ốp điện thoại</p>
          <p className='irIKAp'>Model iPhone tương thích:</p>
          <p className='irIKAp'>Iphone 7 Plus = iPhone 8 Plus</p>
          <p className='irIKAp'>Iphone X = iPhone XS</p>
          <p className='irIKAp'>Iphone XR</p>
          <p className='irIKAp'>Iphone 11</p>
          <p className='irIKAp'>Iphone 11 Pro Max</p>
          <p className='irIKAp'>Iphone 12</p>
          <p className='irIKAp'>Iphone 12 Pro Max</p>
          <p className='irIKAp'></p>
          <p className='irIKAp'>Gói hàng bao gồm: 1 x Ốp điện thoại</p>
          <p className='irIKAp'></p>
